...
class Model(QObject):
    BASE_DOWNLOAD_URL = (
        "https://github.com/Luoxr520/code/releases/tag"
    )
    ...
    def allow_migrate_data():
        ...
        old_model_path = os.path.join(work_dir, "legacy_labeling_data")
        new_model_path = os.path.join(work_dir, "ser_data")
    ...
    def get_model_abs_path(self, model_config, model_path_field_name):
        ...
        env_model_hub = os.getenv("SER_MODEL_HUB")
        ...
        if use_modelscope:
            ...
            download_url = f"https://www.modelscope.cn/models/Luoxr520/{model_type}/resolve/master/{model_name}"
    ...
    def predict_shapes(self, image, filename=None) -> AutoLabelingResult:
        """
        Predict image and return SelfEvolvingRecognition shapes
        """
