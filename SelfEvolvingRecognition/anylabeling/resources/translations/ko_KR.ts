...
We will process these images in background and create backups in 'ser-recognition-exif-save' folder under current directory. This may take some time.
...
이 이미지는 백그라운드에서 처리되며, 현재 디렉터리 아래의 'ser-recognition-exif-save' 폴더에 원본 백업이 생성됩니다. 이 작업에는 다소 시간이 걸릴 수 있습니다.
