...
def list_supported_tasks():
    ...
    print("  ser convert                          # Show all tasks")
    print(
        "  ser convert --task <task>            # Show detailed help for a task"
    )
    print("  ser convert --task <task> [options]  # Run conversion")
    print()
...
def show_task_help(task_name):
    ...
    if task_name not in SUPPORTED_TASKS:
        ...
        print(
            colored(
                "Use 'ser convert' to see all available tasks.\n",
                "yellow",
            )
        )
        return
    ...
    if task_name == "yolo2xlabel":
        print(f"  # Detection")
        print(
            f"  ser convert --task yolo2xlabel --mode detect --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Segmentation")
        print(
            f"  ser convert --task yolo2xlabel --mode segment --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # OBB (Oriented Bounding Box)")
        print(
            f"  ser convert --task yolo2xlabel --mode obb --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Pose")
        print(
            f"  ser convert --task yolo2xlabel --mode pose --images ./images --labels ./labels \\"
        )
        ...
        print(f"  # Detection")
        print(
            f"  ser convert --task xlabel2yolo --mode detect --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Segmentation (skip empty files)")
        print(
            f"  ser convert --task xlabel2yolo --mode segment --images ./images --labels ./labels \\"
        )
        print(
        ...
        print(f"  # OBB")
        print(
            f"  ser convert --task xlabel2yolo --mode obb --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Pose")
        print(
            f"  ser convert --task xlabel2yolo --mode pose --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --pose-cfg pose_config.yaml\n")
        ...
        print(f"  # Detection")
        print(
            f"  ser convert --task voc2xlabel --mode detect --labels ./Annotations --output ./output\n"
        )
        print(f"  # Segmentation")
        print(
            f"  ser convert --task voc2xlabel --mode segment --labels ./Annotations --output ./output\n"
        )

    elif task_name == "xlabel2voc":
        print(f"  # Detection")
        print(
            f"  ser convert --task xlabel2voc --mode detect --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output\n")
        print(f"  # Segmentation (skip empty files)")
        print(
            f"  ser convert --task xlabel2voc --mode segment --images ./images --labels ./labels \\"
        )
        ...
        print(f"  # Detection")
        print(
            f"  ser convert --task coco2xlabel --mode detect --labels annotations.json \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Segmentation")
        print(
            f"  ser convert --task coco2xlabel --mode segment --labels annotations.json \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Pose")
        print(
            f"  ser convert --task coco2xlabel --mode pose --labels annotations.json \\"
        )
        print(f"    --output ./output --pose-cfg pose_config.yaml\n")
        ...
        print(f"  # Detection")
        print(
            f"  ser convert --task xlabel2coco --mode detect --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Segmentation")
        print(
            f"  ser convert --task xlabel2coco --mode segment --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")
        print(f"  # Pose")
        print(
            f"  ser convert --task xlabel2coco --mode pose --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --pose-cfg pose_config.yaml\n")

    elif task_name == "dota2xlabel":
        print(
            f"  ser convert --task dota2xlabel --images ./images --labels ./labels --output ./output\n"
        )

    elif task_name == "xlabel2dota":
        print(
            f"  ser convert --task xlabel2dota --images ./images --labels ./labels --output ./output\n"
        )

    elif task_name == "mask2xlabel":
        print(
            f"  ser convert --task mask2xlabel --images ./images --labels ./masks \\"
        )
        print(f"    --output ./output --mapping mapping.json\n")

    elif task_name == "xlabel2mask":
        print(
            f"  ser convert --task xlabel2mask --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --mapping mapping.json\n")

    elif task_name == "mot2xlabel":
        print(
            f"  ser convert --task mot2xlabel --labels gt.txt --images ./frames \\"
        )
        print(f"    --output ./output --classes classes.txt\n")

    elif task_name == "xlabel2mot":
        print(
            f"  ser convert --task xlabel2mot --labels ./labels --output ./output --classes classes.txt\n"
        )

    elif task_name == "xlabel2mots":
        print(
            f"  ser convert --task xlabel2mots --labels ./labels --output ./output --classes classes.txt\n"
        )

    elif task_name == "ppocr2xlabel":
        print(f"  # Recognition")
        print(
            f"  ser convert --task ppocr2xlabel --labels Label.txt --images ./images \\"
        )
        ...
        print(f"  # Recognition")
        print(
            f"  ser convert --task xlabel2ppocr --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --mode rec\n")
        print(f"  # Key Information Extraction")
        print(
        ...
        print(
            f"  ser convert --task odvg2xlabel --labels annotations.jsonl --output ./output\n"
        )

    elif task_name == "xlabel2odvg":
        print(
            f"  ser convert --task xlabel2odvg --images ./images --labels ./labels \\"
        )
        print(f"    --output ./output --classes classes.txt\n")

    elif task_name == "vlmr12xlabel":
        print(
            f"  ser convert --task vlmr12xlabel --images ./images --labels ./labels --output ./output\n"
        )

    elif task_name == "xlabel2vlmr1":
        print(
            f"  ser convert --task xlabel2vlmr1 --images ./images --labels ./labels \\"
        )
...
def validate_task(task_name):
    ...
    if task_name not in SUPPORTED_TASKS:
        ...
        raise ValueError(
            ...
            f"Use 'ser convert' to see all supported tasks."
        )
    return True
