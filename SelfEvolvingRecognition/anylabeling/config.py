...
def set_work_directory(directory: str) -> None:
    """
    Sets the working directory for SelfEvolvingRecognition.
...
def get_work_directory() -> str:
    """
    Gets the working directory for SelfEvolvingRecognition.
...
def save_config(config):
    user_config_file = osp.join(get_work_directory(), ".serrc")
    try:
