...
"""
The onnxruntime demo of the YOLO
Written by Wei Wang (CVHub)
    Usage:
        1. Download source code from [huggingface/stevengrove/YOLO](https://huggingface.co/spaces/stevengrove/YOLO)
        2. cd YOLO and pip install -r requirements.txt
        3. export PYTHONPATH=/path/to/your/YOLO
